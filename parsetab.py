...
_lr_productions = [
  ...
  ('start -> OPENLIST DATE content CLOSELIST','start',4,'p_start','singapore.py',65),
  ('start -> DATE content CLOSELIST','start',3,'p_start','singapore.py',66),
  ('content -> CONTENT content','content',2,'p_content','singapore.py',89),
  ('content -> DATE content','content',2,'p_content','singapore.py',90),
  ('content -> OPENLIST content CLOSELIST content','content',4,'p_content','singapore.py',91),
  ('content -> <empty>','content',0,'p_content','singapore.py',92),
  ('skipstart -> GARBAGE skipstart','skipstart',2,'p_skipstart','singapore.py',107),
  ('skipstart -> <empty>','skipstart',0,'p_skipstart','singapore.py',108),
]
